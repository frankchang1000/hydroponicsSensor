...
class tempSensorPCT2075(i2c):
    ...
    def __init__(self, address=None, busID=None, interface=None, busLogger=None):
        # Call super init
        super(self.__class__, self).__init__(address, busID, interface, None)
...
if __name__ == "__main__":
    ...
    temp0 = tempSensorPCT2075(temp0_addr, None, bus, None)
   #temp1 = tempSensorPCT2075(temp1_addr, None, bus, None)
